...
from ..types import SchedulerTaskDict
...
def scheduler_task_filter_by_date_interval(tasks: List[SchedulerTaskDict], start_date: datetime, end_date: datetime) -> Dict[str, int]:
