# Generated by Django 3.1.3 on 2020-11-10 23:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_handlers', to='main.crawlrequest')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter_type', models.CharField(choices=[('formatted_str', 'Código formatado'), ('number_seq', 'Sequência numérica'), ('date_seq', 'Sequência de datas'), ('alpha_seq', 'Sequência alfabética')], default='none', max_length=15)),
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameter_handlers', to='main.crawlrequest')),
            ],
        ),
        migrations.CreateModel(
