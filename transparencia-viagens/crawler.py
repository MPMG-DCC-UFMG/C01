...
prefs = {'download.default_directory' : '/home/lorena/Desktop/Lorena/Programming/C04/transparencia-viagens/csvs'}
chrome_options.add_experimental_option('prefs', prefs)
driver = webdriver.Chrome(chrome_options=chrome_options)

driver.get('http://transparencia.mg.gov.br/estado-pessoal/viagens')
time.sleep(2)

year_button = '//*[@id="jform_ano"]'
submit_button = '//*[@id="estado_viagens-form"]/div[7]/div/button'
show_all = '//*[@id="DataTables_Table_0_wrapper"]/div[1]/ul/li[5]/a'
csv_button = '//*[@id="DataTables_Table_0_wrapper"]/div[1]/a[2]'

# viagens referentes aos anos 2012 a 2020
for i in range(1, 9):
